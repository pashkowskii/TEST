...
describe Temperature do
  ...
  describe "can be constructed with an options hash" do
    describe "in degrees fahrenheit" do
      it "at 50 degrees" do
        Temperature.new(:fahrenheit => 50).in_fahrenheit.should == 50
      end

      describe "and correctly convert to celsius" do
        it "at freezing" do
          Temperature.new(:fahrenheit => 32).in_celsius.should == 0
        end

        it "at boiling" do
          Temperature.new(:fahrenheit => 212).in_celsius.should == 100
        end

        it "at body temperature" do
          Temperature.new(:fahrenheit => 98.6).in_celsius.should == 37
        end

        it "at an arbitrary temperature" do
          Temperature.new(:fahrenheit => 68).in_celsius.should == 20
        end
      end
    end
    ...
    describe "in degrees celsius" do
      it "at 50 degrees" do
        Temperature.new(:celsius => 50).in_celsius.should == 50
      end

      describe "and correctly convert to fahrenheit" do
        it "at freezing" do
          Temperature.new(:celsius => 0).in_fahrenheit.should == 32
        end

        it "at boiling" do
          Temperature.new(:celsius => 100).in_fahrenheit.should == 212
        end

        it "at body temperature" do
          Temperature.new(:celsius => 37).in_fahrenheit.should be_within(0.1).of(98.6)
